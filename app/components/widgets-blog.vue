<template>
    <div class="pk-grid-large pk-width-sidebar-large" uk-grid>
        <div class="pk-width-content">
            <div class="uk-margin">
                <label for="form-title" class="uk-form-label">{{
                    "Title" | trans
                }}</label>
                <v-input
                    id="form-title"
                    ...
                    >
                        <label>
                            <input
                                ...
                                :value="category.id"
                                v-model="widget.data.selectedCategories"
                            />
                            {{ category.title }}
                        </label>
                    </p>
...
const WidgetsBlogs = {
    ...
    methods: {
        getCategories() {
            this.$http
                .get("api/medusa/getblogscategories")
                .then(res => {
...
window.Widgets.components["medusa-blogs.settings"] = WidgetsBlogs;
</script>
