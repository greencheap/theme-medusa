            ...
            <div class="uk-container" uk-navbar>
                <div class="uk-navbar-left">
                    <?php if($view->position()->exists('navbar-vertical')): ?>
                        <a class="uk-navbar-item uk-text-primary" uk-icon="icon:more-vertical;ratio:1.1" uk-toggle="target:#socialMediaArea; animation: uk-animation-fade"></a>
                        <div id="socialMediaArea" hidden>
                            <ul uk-grid>
                ...
                <div class="uk-navbar-center">
                    ...
                    <a class="uk-navbar-item uk-margin-left uk-margin-right uk-logo" href="<?= $view->url()->get() ?>">
                        <?php if ($params['logo']) : ?>
